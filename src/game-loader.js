(async () => {
  ...
  code = code.replace("ctx.fillText('BRAKE', W / 2, 164);", "ctx.fillText('TOM', W / 2, 164);");
  code = code.replace("ctx.fillText('HOLD BEFORE THE SHORELINE', W / 2, 178);", "ctx.fillText('Hit the brake!', W / 2, 178);");
  code = code.replace("ctx.fillText('HOLD BEFORE THE CLIFF', W / 2, 178);", "ctx.fillText('Hit the brake!', W / 2, 178);");

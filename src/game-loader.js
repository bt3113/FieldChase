(async () => {
  ...
  code = code.replace(
    ...
    "    ctx.fillText('We are still pioneers', W / 2, 176);\n    ctx.font = '500 9px Montserrat, Arial, sans-serif';\n    ctx.fillStyle = 'rgba(216,200,168,0.82)';\n    ctx.fillText('Copyright: Paramount Pictures, Warner Bros. Entertainment, and Legendary Pictures', W / 2, 204);\n    ctx.textAlign = 'left';"
  );
